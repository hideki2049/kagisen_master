$(function(){
    ...
    if($.cookie("semester") !== null)$('#semester').val($.cookie("semester"));  
    if($.cookie("teachercd") !== null)$('#teachercd').val($.cookie("teachercd"));  
    ...
    if($.cookie("teachertype") !== null)$('#teachertype').val($.cookie("teachertype")); 
    ...
    $('#search_btn').on('click',function(){
        ...
        $.cookie("semester",$('#semester').val(),{ expires: date });  
        $.cookie("teachercd",$('#teachercd').val(),{ expires: date });  
        ...
        $.cookie("teachertype",$('#teachertype').val(),{ expires: date }); 
...
//            console.log(status);
    ...
    $(document).on('click','.edit_btn', function() {
        ...
        //  teachercdのクラスを取得 -------------------------------------------------------------------!!!!
        var teacher = $('tr#' + index).find('td').eq(3).attr('class');
