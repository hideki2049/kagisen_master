...
<html>
    <head>
        ...
        <script type="text/javascript" src="search_t.js"></script>
    ...
    <body link="blue" vlink="blue">
        ...
        <div class="event_notice">
            <center><font size="10px">アカウント管理：教員</center></font>
        </div>
        ...
        <div class="main">
            ...
            <th style="border-style: none;width: 10px;background: white;">教員コード</th>
            ...
            <th style="border-style: none;width: 10px;background: white;">教員属性</th>
            </tr>
            ...
            <tr>
                ...
                <th style="border-style: none; background: white;">
                    <!-- 教員コード -->
                    <input type="text" style="ime-mode: disabled" id="teachercd" size="10" class="enter_btn" style="ime-mode: disabled;">
                </th>
                <th style="border-style: none; background: white;">
                    <!-- 名前 -->
                ...
                <th style="border-style: none; background: white;">
                    <!-- 教員属性 -->
                    <select id="teachertype" class="enter_btn">
                        <option value="">なし</option>
